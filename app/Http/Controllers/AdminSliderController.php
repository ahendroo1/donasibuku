...
class AdminSliderController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
		...
		$this->form = array();
		$this->form[] = array("label"=>"Image","name"=>"image","type"=>"upload_standard","required"=>TRUE,"validation"=>"required|min:3","help"=>"File types support : JPG, JPEG, PNG, GIF, BMP","upload_file"=>FALSE);
		$this->form[] = array("label"=>"Link","name"=>"link","type"=>"text","required"=>TRUE,"validation"=>"required|url","placeholder"=>"Please enter a valid URL");
