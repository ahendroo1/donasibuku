...
class AdminBukuFavoriteController extends \crocodicstudio\crudbooster\controllers\CBController {

    public function __construct() {
        $this->table              = "buku_favorite";
        $this->primary_key        = "id";
		...
		$this->col[] = array("label"=>"Link","name"=>"link" );
		$this->col[] = array("label"=>"Created","name"=>"datetime" );
		...
		$this->form[] = array("label"=>"Link","name"=>"link","type"=>"text","required"=>TRUE,"validation"=>"required","placeholder"=>"Please enter a valid URL");
		$this->form[] = array("label"=>"Created","name"=>"datetime","type"=>"datetime","required"=>TRUE,"readonly"=>true,"value"=>date("Y-m-d H:i:s"));
