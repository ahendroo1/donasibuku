...
class ApiTbmLupaSandiController extends \crocodicstudio\crudbooster\controllers\ApiController {

    function __construct() {    
        $this->table     = "tbm";        
        $this->permalink = "tbm_lupa_sandi";    
    ...
    public function hook_before(&$postdata) {
        ...
        $html  = "<h2>Kemendikbud - TBM, Lupa Sandi</h2>
                <p>Silahkan Login ke akun TBM dengan email dan password di bawah ini :</p>
                <p>Email : ".$email."</p>
