...
class AdminMasterSpmController extends \crocodicstudio\crudbooster\controllers\CBController {

    public function __construct() {
        $this->table              = "master_spm";
        $this->primary_key        = "id";
        ...
        $this->col = array();
        $this->col[] = array("label"=>"TBM","name"=>"id_master_tbm","join"=>"master_tbm,name" );
		$this->col[] = array("label"=>"Name","name"=>"name" );

		$this->form = array();
        $this->form[] = array("label"=>"TBM","name"=>"id_master_tbm","type"=>"select2","datatable"=>"master_tbm,name","required"=>TRUE);
