...
class AdminTokoBukuController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
		...
		$this->form[] = array("label"=>"Desk","name"=>"desk","type"=>"textarea");
		...
		$this->form[] = array("label"=>"Link","name"=>"link","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255|url","placeholder"=>"Please enter a valid URL");
