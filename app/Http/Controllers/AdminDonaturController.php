...
class AdminDonaturController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
        ...
        $this->col = array();
        $this->col[] = array("label"=>"ID Donatur","name"=>"donatur.id" );
		$this->col[] = array("label"=>"Nama","name"=>"nama" );
		$this->col[] = array("label"=>"Instansi","name"=>"instansi" );
		...
		$this->form[] = array("label"=>"Instansi","name"=>"instansi","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
		$this->form[] = array("label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:3|max:255|email|unique:donatur","placeholder"=>"Please enter a valid email address");
