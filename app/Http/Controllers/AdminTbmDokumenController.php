...
class AdminTbmDokumenController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
        ...
        $this->col = array();
		$this->col[] = array("label"=>"Upload","name"=>"upload",'image'=>1 );

		$this->form = array();
		$this->form[] = array("label"=>"Upload","name"=>"upload","type"=>"upload","required"=>TRUE,"validation"=>"required");
    ...
    public function hook_row_index(&$html,$data) {
        ...
        foreach ($html as &$item) {
            ...
            if(in_array($extension, $array_extImage)){
                ...
                $item[1] = '<a href="'.$upload.'" class="btn btn-primary" target="_blank">'.substr($data[$i]->upload, 48).'</a>';
            }
            $i++;
        }
