...
class AdminLinkTerkaitController extends \crocodicstudio\crudbooster\controllers\CBController {

    public function __construct() {
        $this->table              = "link_terkait";
        $this->primary_key        = "id";
		...
		$this->col[] = array("label"=>"Link Terkait","name"=>"link_terkait" );
		...
		$this->form[] = array("label"=>"Link Terkait","name"=>"link_terkait","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
