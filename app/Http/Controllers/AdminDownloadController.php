...
class AdminDownloadController extends \crocodicstudio\crudbooster\controllers\CBController {

    public function __construct() {
        $this->table              = "download";
        $this->primary_key        = "id";
        $this->title_field        = "nama_file";
        $this->limit              = 20;
        ...
        $this->col = array();
		$this->col[] = array("label"=>"Nama File","name"=>"nama_file" );
		$this->col[] = array("label"=>"File","name"=>"file" );

		$this->form = array();
		$this->form[] = array("label"=>"Nama File","name"=>"nama_file","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
		$this->form[] = array("label"=>"File","name"=>"file","type"=>"upload_standard","required"=>TRUE,"validation"=>"required","upload_file"=>FALSE);
