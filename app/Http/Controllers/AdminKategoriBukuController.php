...
class AdminKategoriBukuController extends \crocodicstudio\crudbooster\controllers\CBController {

    public function __construct() {
        $this->table              = "kategori_buku";
        $this->primary_key        = "id";
		...
		$this->form = array();
		$this->form[] = array("label"=>"Nama","name"=>"nama","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255|alpha_spaces");
