...
class AdminKotaController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
        ...
        $this->col = array();
		$this->col[] = array("label"=>"Propinsi","name"=>"id_propinsi","join"=>"propinsi,propinsi");
		$this->col[] = array("label"=>"Kabupaten","name"=>"kabupaten" );

		$this->form = array();
        $this->form[] = array("label"=>"Provinsi","name"=>"id_propinsi","type"=>"select2","datatable"=>"propinsi,propinsi","required"=>TRUE);
		$this->form[] = array("label"=>"Kabupaten","name"=>"kabupaten","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
