...
class AdminFaqController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
        ...
        $this->col = array();
		$this->col[] = array("label"=>"Ask","name"=>"ask" );
		$this->col[] = array("label"=>"Answer","name"=>"answer","str_limit"=>100 );

		$this->form = array();
		$this->form[] = array("label"=>"Ask","name"=>"ask","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
		$this->form[] = array("label"=>"Answer","name"=>"answer","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000");
