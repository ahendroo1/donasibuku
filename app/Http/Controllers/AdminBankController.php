...
class AdminBankController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
        ...
        $this->col = array();
        $this->col[] = array("label"=>"Image","name"=>"image",'image'=>1 );
        $this->col[] = array("label"=>"Bank","name"=>"bank" );
		$this->col[] = array("label"=>"An","name"=>"an" );
		$this->col[] = array("label"=>"Norek","name"=>"norek" );
		$this->col[] = array("label"=>"Cabang","name"=>"cabang" );

		$this->form = array();
        $this->form[] = array("label"=>"Image","name"=>"image","type"=>"upload_standard","required"=>TRUE,"validation"=>"required");
        $this->form[] = array("label"=>"Bank","name"=>"bank","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
		...
		$this->form[] = array("label"=>"Cabang","name"=>"cabang","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
