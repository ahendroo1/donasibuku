...
class AdminIklanController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
        ...
        $this->col = array();
        $this->col[] = array("label"=>"Bagian","name"=>"bagian" );
		$this->col[] = array("label"=>"Image","name"=>"image" ,"image"=>true);
		$this->col[] = array("label"=>"Url","name"=>"url" );

		$this->form = array();
        $this->form[] = array("label"=>"Bagian","name"=>"bagian","type"=>"text","readonly"=>TRUE);
		...
		$this->form[] = array("label"=>"Url","name"=>"url","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255|url","placeholder"=>"Please enter a valid URL");
