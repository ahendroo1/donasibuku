...
class AdminMasterSpnfController extends \crocodicstudio\crudbooster\controllers\CBController {

    public function __construct() {
        $this->table              = "master_spnf";
        $this->primary_key        = "id";
        ...
        $this->col = array();
        $this->col[] = array("label"=>"Kategori","name"=>"id_master_spm","join"=>"master_spm,name" );
		$this->col[] = array("label"=>"Name","name"=>"name" );

		$this->form = array();
        $this->form[] = array("label"=>"Kategori","name"=>"id_master_spm","type"=>"select2","datatable"=>"master_spm,name","required"=>TRUE);
