...
<div class="box-container bg-login" id="box-container">
	<div class="container">
		<div class="col-md-8 col-md-offset-2">
			<div class="wrapper-form m-t-50">
				<ul class="nav nav-tabs">
					<li class="{{$donatur}}"><a data-toggle="tab" href="#donatur">DONATUR</a></li>
					<li class="{{$tbm}}"><a data-toggle="tab" href="#tbm">TBM</a></li>
				</ul>

				<div class="tab-content login">
					<div id="donatur" class="tab-pane fade {{$donatur}}">
						<div class="box-form">
							<div class="col-md-8 col-md-offset-2">
								<div id="login-donatur" {!!$style_logi!!}>
									...
									<form action="{{action("FrontController@postLoginDonatur")}}" method="post">
										...
										<div class="form-group">
											<input type="password" class="form-control" required autocomplete="false" name="password">
											<label class="form-control-placeholder" for="password">Password</label>
										</div>

										<div class="form-group">
											<div class="col-md-5">
												<button class="btn menu-login blue" type="submit">Masuk</button>
											...
											<div class="col-md-5">
												<button class="btn btn-default menu-login" type="button" onclick="DoRegisterDonatur()">Daftar</button>
											</div>
										</div>
									</form>
									<div class="col-md-12 lupa-kata">
										<center><a href="javascript:void(0);" data-toggle="modal" data-target="#modalLupaSandiDon">Lupa Kata Sandi?</a></center>
									</div>
								</div>
								<div id="register-donatur" {!!$style_regi!!}>
									<a href="javascript:;" onclick="DoLoginDonatur()" class="custom-text"><i class="fa fa-chevron-left"></i> Masuk sebagai donatur</a>
									...
									<form method="post" action="{{action("FrontController@postRegisterDonatur")}}" class="validatedForm">
										...
										<div class="form-group m-t-30">
											<div class="col-md-12">
												<center>
													<button class="btn btn-default menu-login" type="submit" id="button-register">Daftar</button>
												</center>
											</div>
										</div>
									</form>
					...
					<div id="tbm" class="tab-pane fade {{$tbm}}">
						<div class="box-form">
							<center><h3>Masuk</h3></center>
							<div class="col-md-8 col-md-offset-2">
								<form action="{{action("FrontController@postLoginTbm")}}" method="post">
									...
									<div class="form-group">
										<div class="col-md-5">
											<button type="submit" class="btn menu-login blue">Masuk</button>
