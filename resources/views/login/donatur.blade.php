				...
				<div class="tab-content login ">
                    <div class="box-form">
                        <div id="login-donatur" {!!$style_logi!!}>
                            <center><h3>Masuk Donatur</h3></center>
                            <form action="{{action("FrontController@postLoginDonatur")}}" method="post" class="m-t-40">
                                ...
                                <div class="form-group">
                                    <div class="col-md-5">
                                        <center><button class="btn menu-login blue" type="submit">Masuk</button></center>
                                    </div>
                                    <div class="col-md-2">
